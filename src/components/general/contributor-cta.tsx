...
const ContributorCTA = ({
  ...
  return (
    <div
      className={cn(
        "w-full bg-gradient-to-br from-foreground via-foreground/95 to-foreground/80 text-background rounded-2xl p-8 lg:p-10",
        className
      )}
    >
      <h2 className="font-miller text-3xl lg:text-4xl xl:text-5xl font-semibold italic mb-3">
        Your Voice,
        <br />
        Your Platform.
      </h2>

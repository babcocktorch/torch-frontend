...
- **Campus News:** Breaking news, institutional updates, student government, investigations.
- **Innovation & Tech:** Startups, hackathons, GDG, BUCC, and the builders on campus.
- **Arts & Culture:** Theatre, music, CWC, film, creative writing, and campus creativity.
- **Opinion:** Editorials and columns — always clearly labelled as opinion.
- **Sports:** Match coverage, athlete profiles, intramural games.
- **Faith & Community:** Ministry, outreach, and campus spiritual life.
- **Student Life:** Welfare, housing, mental health, dining, and everyday Babcock.
- **Alumni:** Graduate stories, mentorship, and the Babcock legacy.
...
## 02 · ETHICS & PRINCIPLES
### Our Ethics

These are not aspirations. They are the commitments we hold ourselves to on every story, with every source, every time.

- **Truth:** We report what we can verify. We acknowledge uncertainty. We do not distort facts to fit a narrative.
- **Independence:** We serve our readers — not sponsors, student unions, or the administration.
- **Fairness:** We give everyone a fair hearing before we publish a story about them.
- **Minimise Harm:** We weigh what is worth reporting against the harm reporting may cause.
- **Accountability:** We correct mistakes quickly, openly, and without excuses.
- **Dignity:** We treat every person — source, subject, reader — with basic human respect.
...
―― ◆ ――  
*Our readers trust us with their attention. We treat that trust as the most valuable thing we have.*
...
- **01 Minor Correction:** A typo, misspelled name, or wrong figure that does not change the story's meaning.
- **02 Significant Correction:** A wrong factual claim, misattributed quote, or missing context that changes how you understand a story.
- **03 Clarification:** Where the original was accurate but ambiguous — we add context without altering the substance.
- **04 Editor's Note:** Context added after publication when circumstances have materially changed.
- **05 Retraction:** If a story is substantially wrong or fabricated, we retract it fully and say so clearly.

**How to Report an Error**

Contact us at [editor@babcocktorch.com](mailto:editor@babcocktorch.com). We acknowledge within 48 hours and publish a correction within 72 hours if confirmed. You will hear back from us either way.
...
- Influence over editorial decisions or story selection.
- The right to review or approve content before publication.
- Favourable coverage in exchange for commercial support.
- The right to pull advertising in order to suppress a story.
...
- Defamatory content or unverified factual claims about identifiable individuals.
- Content that harasses, threatens, or demeans on the basis of gender, religion, ethnicity, or sexual orientation.
- Plagiarised work or content generated entirely by AI and submitted as original writing.
- Content that could endanger a student's safety or reveal information shared in confidence.
...
―― ◆ ――  
*The Torch belongs to Babcock. Every student here has a story worth telling.*  
...
- **Editorial queries:** Managing Editor · babcocktorch.com/contact
- **Error corrections:** babcocktorch.com/contact · 48-hour acknowledgement
- **Copyright complaints:** Editor-in-Chief · 14-day response
- **Data & privacy:** babcocktorch.com · 14-day response
- **Right of reply:** Editor-in-Chief in writing
- **General enquiries:** babcocktorch.com/contact

The Babcock Torch  
*Documenting Brilliance. Inspiring the Future.*

―― ◆ ――  
Babcock University · Ilishan-Remo, Ogun State · babcocktorch.com

© The Babcock Torch 2025. Content may be shared non-commercially with attribution and a link to babcocktorch.com.
`;
      ...
      <ReactMarkdown
        components={{
          ...
          h2: ({ children, ...props }) => {
            ...
            else if (text.includes("ETHICS")) id = "ethics";
            else if (text.includes("LICENSING")) id = "licensing";
            else if (text.includes("LEGAL")) id = "legal";

            return (
              <h2
                id={id}
                className="text-xl sm:text-2xl font-miller font-bold mt-10 mb-2 text-gold tracking-wide uppercase border-b border-border pb-2"
                {...props}
              >
                {children}
              </h2>
